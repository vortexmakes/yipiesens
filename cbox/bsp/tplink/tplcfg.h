...
#define TPLINK_MAX_PLOAD_SIZE	50					/* Max Payload Size */

#define TPLINK_BASE_TIME		20					/* Tplink base time tick */

#define TPLINK_INTER_BYTE_TIME	(40/TPLINK_BASE_TIME)	/* Inter Byte timeout in ms */
#define TPLINK_INTER_FRAME_TIME	(1000/TPLINK_BASE_TIME) /* Inter Frame timeout in ms */


#define __USE_TPLINK_ONXMIT_CMP_CBF__	0			/* Enable/Disable transmit complete call back function */
#define __USE_TPLINK_ONCHERR_CBF__		0			/* Enable/Disable check sum error call back function */
